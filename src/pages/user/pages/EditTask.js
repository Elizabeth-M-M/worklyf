...
export default function EditTask() {
  ...
  const handleSubmit = (event) => {
    ...
    dispatch(editTask({ id: id, task: taskFormData })).then((data) => {
                            ...
                            <div className="mb-2 flex items-center justify-between">
                              <div className=" bg-gray-dark rounded bg-gray-light  p-2">
                                ...
                                <input
                                  ...
                                  name="start_date"
                                  value={
                                    taskFormData.start_date !== undefined &&
                                    taskFormData.start_date.split("T")[0]
                                  }
                                  onChange={handleInputs}
                                  required
                                />
                              ...
                              <div className=" bg-gray-dark rounded bg-gray-light  p-2">
                                ...
                                <input
                                  ...
                                  name="start_time"
                                  value={
                                    taskFormData.start_time !== undefined &&
                            ...
                            <div className="mb-2 flex items-center justify-between">
                              <div className=" bg-gray-dark rounded bg-gray-light  p-2">
                                ...
                                <input
                                  ...
                                  name="end_date"
                                  value={
                                    taskFormData.end_date !== undefined &&
                              ...
                              <div className=" bg-gray-dark rounded bg-gray-light  p-2">
                                ...
                                <input
                                  ...
                                  name="end_time"
                                  value={
                                    taskFormData.end_time !== undefined &&
